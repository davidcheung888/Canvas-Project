class DrawingCircleNotFill extends MouseMethods {
 ...
 * ==================================
 ***********************************************/
let circleNotFill = document.getElementById("DrawingCircleNotFill");
circleNotFill.addEventListener("click", function () {
  console.log("DrawingCircleNotFill Button clicked");
  currentFunction = new DrawingCircleNotFill(contextReal, contextDraft);
});
